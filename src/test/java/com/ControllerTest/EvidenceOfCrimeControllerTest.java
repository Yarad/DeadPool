...
public class EvidenceOfCrimeControllerTest {
    ...
    public void addEvidenceForCrime() throws Exception {
        ...
        when(evidenceOfCrimeService.addEvidenceOfCrime(inputJson.getEvidence().getId(), inputJson.getCrime().getId(), inputJson.getType(), inputJson.getDateAdded(), inputJson.getDetails(), inputJson.getPhotoPath())).thenReturn(true);
    ...
    public void updateEvidenceForCrime() throws Exception {
        ...
        when(evidenceOfCrimeService.updateEvidenceOfCrime(inputJson.getEvidence().getId(), inputJson.getCrime().getId(), inputJson.getType(), inputJson.getDateAdded(), inputJson.getDetails(), inputJson.getPhotoPath())).thenReturn(true);
