...
public interface IDAOCrime {
     ...
     * */
    List<Crime> getCrimesBetweenDates(String dateStart, String dateEnd);
     ...
     */
    Crime getCrimeWithCriminalCase(int crimeId);
     ...
     */
    List<Crime> getCrimesByCriminalCase(int caseId);
}
